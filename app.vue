...
// SEO Meta
useHead({
  title: 'Car Rental Delhi - Premium Car Rental with Driver, Sedan | Delhi NCR',
  meta: [
    {
      name: 'description',
      content: 'Book premium sedan with professional driver in Delhi NCR. Outstation trips to Jaipur, Agra, Rishikesh & more. Airport transfers, corporate, VIP transport available.',
    },
    { property: 'og:title', content: 'Car Rental Delhi - Premium Car Rental with Driver, Sedan' },
    {
      property: 'og:description',
      content: 'Book premium sedan with professional driver in Delhi NCR and outstation trips.',
    },
